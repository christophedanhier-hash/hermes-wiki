...
```bash
python3 ~/.hermes/profiles/michel/scripts/search_arxiv.py --query "hermes agent LLM" --max 5
```

### Recherche par auteur

```bash
python3 ~/.hermes/profiles/michel/scripts/search_arxiv.py --author "danhier" --max 10
```

### Recherche par catégorie

```bash
python3 ~/.hermes/profiles/michel/scripts/search_arxiv.py --category cs.AI --sort date --max 20
```
...
```bash
# Indexer le wiki
python3 ~/.hermes/profiles/michel/scripts/index_wiki.py ~/Projets_Dev/BAVI_LEO/docs/

# Interroger
python3 ~/.hermes/profiles/michel/scripts/query_wiki.py "Comment configurer un gateway ?"
```
...
```bash
# Derniers marchés
python3 ~/.hermes/profiles/michel/scripts/polymarket.py --trending

# Prix d'un marché spécifique
python3 ~/.hermes/profiles/michel/scripts/polymarket.py --slug "will-agi-exist-by-2030"
```
...
python3 ~/.hermes/profiles/michel/scripts/fetch_transcript.py https://youtu.be/VIDEO_ID

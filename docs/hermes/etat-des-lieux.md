...
> - **Crons** : Auto-Fix Daemon supprimé, Deploy Unified Dashboard horaire. 58 crons actifs (michel 50 + LEO 6 + sylvia 2).
...
> **58 crons actifs (michel 50 + LEO 6 + sylvia 2) Hermes** (tous consolidés dans `michel`) → **45 jobs (tous actifs)**

| Profil | Crons |
|--------|:-----:|
| `michel` (consolidateur) | 49 |
| `default` | 0 |
| `sylvia` | 0 |
| `emile` | 0 |
| `robert` | 0 |

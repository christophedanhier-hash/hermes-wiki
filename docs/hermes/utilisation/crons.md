...
> 🚫 **Auto-Heal déprécié le 04/07/2026** — remplacé par le déploiement horaire unifié via `collect-v2.py` et michel. Le watchdog `dashboards-watchdog` vérifie la disponibilité mais ne régénère pas le contenu.

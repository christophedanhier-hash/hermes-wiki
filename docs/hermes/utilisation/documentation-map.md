...
| 15 | `utilisation/crons.md` | **42 crons (39 actifs)** (tous actifs, leo-copilot exclusif), collect-v2 | 14, 16, 21 | ✅ |
...
5. **`utilisation/crons.md`** — 42 crons (39 actifs) (tous actifs), planification
6. **Cette carte** 🗺️

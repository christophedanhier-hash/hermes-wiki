...
**Crons Hermes** — Automatisation native de LEO pour les tâches critiques (retry natif).
...
**Workflow automatisé** — Séquence d'étapes automatisées (crons Hermes ou scripts Python). Utilisé pour les tâches critiques avec retry automatique.
